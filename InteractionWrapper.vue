  ...
  <v-container fluid>
    <v-row>
      <v-col cols="3">
        <v-card class="ma-1">
          <v-tabs
            ...
            dark
            :background-color="
              $store.state.selectedOrganismShown.secondaryColor
            "
          >
            <v-tabs-slider
            ...
            <v-tabs-items v-model="UiModel.tabIndex">
              ...
              <v-tab-item :value="'tab-1'">
                ...
                >
                  <v-expansion-panel
                    v-for="(item, i) in NodeModel.nodes"
                    :key="i"
                    class="ma-1"
                    color="secondary"
                  >
                        ...
                        <v-list-item>
                          ...
                          <v-tooltip top>
                            <template v-slot:activator="{ on, attrs }">
                              <v-btn
                                :color="
                                  $store.state.selectedOrganismShown
                                    .primaryColor
                                "
                                outlined
                                fab
                          ...
                          <v-tooltip top>
                            <template v-slot:activator="{ on, attrs }">
                              <v-btn
                                ...
                                v-bind="attrs"
                                v-on="on"
                                ><v-icon>fas fa-street-view</v-icon></v-btn
                              >
                            </template>
              ...
              <v-tab-item :value="'tab-2'">
                ...
                <v-col align="center">
                  ...
                  <v-btn
                    ...
                    class="ma-2"
                    @click="onSvgClick"
                    ><v-icon>fas fa-download</v-icon>SVG</v-btn
                  >
                  <v-btn
                    dark
                    :color="$store.state.selectedOrganismShown.primaryColor"
                    class="ma-2"
                    @click="onPngClick"
                    ><v-icon>fas fa-download</v-icon>PNG</v-btn
                  >
                  <v-btn
                    dark
                    :color="$store.state.selectedOrganismShown.primaryColor"
                    class="ma-2"
                    @click="onSifClick"
                    ><v-icon>fas fa-download</v-icon>SIF</v-btn
                  >
      ...
      <v-btn
        v-if="UiModel.visibleD3Button"
        :color="$store.state.selectedOrganismShown.primaryColor"
        :disabled="!UiModel.enableExpansion"
        fab
        outlined
        elevation="4"
        absolute
        style="top: 210px; left: 565px"
      ...
      <v-btn
        ...
        elevation="4"
        absolute
        style="top: 280px; left: 565px"
        @click="onButtonPressUnfix"
        ><v-icon>fas fa-unlock-alt</v-icon></v-btn
      >
...
export default {
  ...
  data: function () {
    return {
      ...
      svgCss: [
        require("@/vue-d3-components/d3v4-selectable-zoomable-force-directed-graph.css.prdb"),
      ],
    };
  },
  watch: {
